...
public class BeachPartyThirstProvider extends ThirstDataProvider {
    ...
    public void generate(HolderLookup.Provider provider, ExistingFileHelper existingFileHelper) {
        ...
        consumable("cocoa_cocktail").addThirst(thirstData(5, 3.0f));
        consumable("pumpkin_cocktail").addThirst(thirstData(5, 3.0f));
        consumable("melon_cocktail").addThirst(thirstData(6, 3.0f));
        consumable("honey_cocktail").addThirst(thirstData(7, 6.0f));
        consumable("refreshing_drink").addThirst(thirstData(10, 8.0f));
        consumable("sweetberry_milkshake").addThirst(thirstData(5, 3.0f));
